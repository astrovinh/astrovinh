    ...
    <section id="how" style={{ padding: "60px 32px 80px", maxWidth: 660, margin: "0 auto" }}>
      <Reveal>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <span style={{ fontSize: 9, color: "#D89840", letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 600 }}>{t.how.label}</span>
          <h2 style={{ fontSize: 34, fontWeight: 600, lineHeight: 1.2, marginTop: 10 }}>{t.how.h2a}<br />{t.how.h2b}</h2>
        </div>
      </Reveal>
      {t.how.steps.map((s, i) => (
        <Reveal key={i} delay={i * 0.08}>
          <div style={{ display: "flex", gap: 20, padding: "28px 0", borderBottom: i < 2 ? "1px solid var(--border)" : "none" }}>
            ...
            <div>
              <div style={{ fontSize: 10, color: "var(--accent)", fontWeight: 600, marginBottom: 5 }}>Step {s.step}</div>
